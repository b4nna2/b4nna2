...
import { getCartItems, deleteCartItem, getProduct } from '@src/views/apps/dashboard/store/actions'
      ...
      return (
        <Fragment>
                  ...
                  <Media body>
                    ...
                    <div className='media-heading'>
                      <h6 className='cart-item-title'>
                        <Link
                          className='text-body'
                          to={`/apps/dashboard/product/${item.slug}`}
          ...
          <li className='dropdown-menu-footer'>
            ...
            <Button.Ripple tag={Link} to='/apps/dashboard/checkout' color='primary' block onClick={toggle}>
              Checkout
            </Button.Ripple>
          </li>
        </Fragment>
