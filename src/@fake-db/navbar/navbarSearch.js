...
export const searchArr = [
  {
    ...
    data: [
      ...
      {
        id: 3,
        target: 'Manage Places',
        isBookmarked: true,
        title: 'Manage Places',
        // icon: 'Map',
        link: '/apps/user/manageplaces'
      },
      {
        id: 4,
        target: 'Manage States',
        isBookmarked: true,
        title: 'Manage States',
        // icon: 'MessageSquare',
        link: '/forms/managestates'
      },
      {
        id: 5,
        target: 'Trip',
      ...
      {
        id: 6,
        target: 'managecountry',
        isBookmarked: true,
        title: 'Manage country',
        // icon: 'Calendar',
        link: '/apps/managecountry'
      },
      {
        id: 7,
        target: 'Blogs',
