...
const FormRoutes = [
  ...
  {
    path: '/forms/managestates',
    component: lazy(() => import('../../views/forms/validations/managestates'))
  },
  {
    path: '/forms/trip',
    component: lazy(() => import('../../views/forms/trip'))
  },
  {
    path: '/forms/tripedit',
    component: lazy(() => import('../../views/forms/tripedit'))
  }
