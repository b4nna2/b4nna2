  ...
  return (
    ...
    <Fragment >
     ...
     <BrowserRouter>
      ...
      <Switch>
        ...
        <Route exact path="/apps/users2/:id" component={EditUser} />
    ...
    <div className="content-wrapper">   
      ...
      <tr>
        ...
        <Link to={`./useredit2/${user._id}`}> <Edit className='' size={15} onClick={() => getUsers(user._id)}/></Link></button>
    ...
    <button className="pagination-button active3">3</button>
    </Link>
