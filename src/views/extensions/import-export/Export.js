        ...
        <Col sm='12'>
          <Card>
            <CardBody className='pb-0'>
              <div className='d-flex justify-content-between flex-wrap flex-sm-row flex-column ml-auto export'>
                <Button.Ripple color='primary' onClick={() => toggleModal()} className="ml-auto">
                  Export
                </Button.Ripple>
