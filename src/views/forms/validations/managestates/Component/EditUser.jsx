...
const EditUser = () => {
    ...
    return (
        <FormGroup className={classes.container}>
            ...
            <FormControl>
                {/* <InputLabel htmlFor="my-input">State</InputLabel> */}<div className="edit-form">State</div>
                <Input onChange={(e) => onValueChange(e)} name='StateName' value={StateName} id="my-input" aria-describedby="my-helper-text" />
            </FormControl>
            <FormControl>
                {/* <InputLabel htmlFor="my-input">Country</InputLabel> */}<div className="edit-form">Country</div>
                <Input onChange={(e) => onValueChange(e)} name='placeLocation' value={placeLocation} id="my-input" aria-describedby="my-helper-text" />
            </FormControl>
            <FormControl>
               <Link to = "../../forms/managestates">
               <Button variant="contained" color="primary" onClick={() => editUserDetails()}>Edit State</Button>
               </Link> 
            </FormControl>
        </FormGroup>
    )
