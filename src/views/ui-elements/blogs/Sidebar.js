          ...
          <Grid item xs={12} sm container>
            <Grid item xs container direction="column" spacing={2}>
              <Grid item xs>
                ...
                <div> <Link to='../../forms/wizard'> <Button  className="buttonhover"> <MdInsertComment className="commentblogs" /> </Button></Link></div><div><Button  className="buttonhover"> <AiFillStar  className="star" /> </Button> </div> <Button  className="buttonhover" onClick={() => setModalIsOpen(true)}> <AiOutlineEye className="eye"/></Button><div> <Link to='../../forms/formik'> <Button  className="buttonhover"> <BsPencilSquare className="edit" /> </Button></Link></div>  <DeleteModal className="delete" />   &nbsp; &nbsp; 
